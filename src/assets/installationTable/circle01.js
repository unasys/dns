...
export default class Circle01 extends React.Component {
 render() {
   let xValue = this.props.text === 'Gas' ? '-3' : '-1.5';
   return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        viewBox="0 0 16.8 16.8" style={{enableBackground:'new 0 0 16.8 16.8', width:this.props.size}}>
        <g>
            <g>
                <text transform="matrix(1 0 0 1 6.1133 10.7141)" x={xValue} style={{fill:'#EEEDED', fontFamily:'Roboto', fontSize:'6px'}}>{this.props.text}</text>
            </g>
