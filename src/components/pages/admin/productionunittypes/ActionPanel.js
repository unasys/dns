...
import AddProductionUnitType from "./AddProductionUnitType";
        ...
        return (
            <div className="action-panel">
                ...
                {this.state.createModelOpen &&
                    <Modal entity={this.props.entity} content={<AddProductionUnitType projectId={this.props.projectId} close={this.closeCreateModel}></AddProductionUnitType>} close={this.closeCreateModel}></Modal>}
            </div>
        )
    }
}
