        ...
        return (
            <div className="action-panel">
                ...
                {this.state.createModelOpen &&
                    <Modal entity={this.props.entity} content={<AddDocumentType projectId={this.props.projectId} close={this.closeCreateModel}></AddDocumentType>} close={this.closeCreateModel}></Modal>}
            </div>
        )
    }
}
