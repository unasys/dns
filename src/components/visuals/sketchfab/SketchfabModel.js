...
class SketchfabModel extends Component {
    ...
    render() {
        ...
        return (
            <Draggable disabled={!this.props.isPopup}>
                <div className={'sketchfab-container ' + (this.props.isPopup ? 'popup' : '') +  (this.state.sketchFabMinimised ? 'click-through': '')}>
                    {this.props.isPopup &&
                    controlButtons}
...
function mapStateToProps(state) {
    let sketchfabId = state.SketchfabReducer.sketchfabId
    let annotationIndex = state.SketchfabReducer.annotationIndex
    let annotationModelId = state.SketchfabReducer.annotationModelId
    return {
