...
import './Panels.scss';
import ConfigInstallationDetailsPanel from '../sliding-panels/panels/details-panel/ConfigInstallationDetailsPanel';
...
function InstallationInfoPanel(props) {
    ...
    let content;
    if (props.installation && props.installation.DetailsPanel) {
        content =
            <>
                {titleBar}
                <ConfigInstallationDetailsPanel
                    installationDetails={props.installation.DetailsPanel}
